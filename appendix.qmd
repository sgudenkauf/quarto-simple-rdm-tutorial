...
## Datenmanagementplan für deutschsprachige Gesundheitsprojekte: `DMP-health.md` {#sec-appendix-dmp-health}
...
- Repositories: (z. B. GitHub und Zenodo ohne sensible Daten, interne Dienste) 
- Aufbewahrungsdauer:
- Löschkonzept:
...
## Informierte Einwilligung: `IC.md` {#sec-appendix-ic}
...
Die Teilnahme ist freiwillig und kann jederzeit ohne Angabe von Gründen
beendet werden.
...
Ich habe die Informationen gelesen und verstanden und erkläre mich mit
...
## Data Use Agreement: `DUA.md` {#sec-appendix-dua}
...
## Beispiele für Metadaten mit Zenodo{#sec-appendix-metadata}


Beispiel: Metadaten dieses Dokuments in der Version 1.0.3 als [DataCite JSON](https://schema.datacite.org/) generiert von Zenodo:
...
Beispiel: Metadaten dieses Dokuments in der Version 1.0.3 als [Dublin Core XML](https://www.dublincore.org/) generiert von Zenodo:
